...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:027500179340:environment/app1-dev-env
...
module "kubernetes-addons" {
  ...
  enable_prometheus                   = false #var.environment.inputs.prometheus
